...
BUSINESS_SPECIFIC_FIGURE_DIR_PATH = f"{FIGURES_DIR_PATH}/business_specific"
...
class FilePaths:
    ...
    USER_DATA_PATH_JSON = f"{DATA_DIR_PATH}/json/user_data.json"
    FEED_DATA_PATH = f"{DATA_DIR_PATH}/feed_data.csv"
    FEED_DATA_PATH_JSON = f"{DATA_DIR_PATH}/json/feed_data.json"
    BUSINESS_DATA_PATH = f"{BUSINESS_DIR_PATH}/business_summarized_all_time.csv"
    BUSINESS_DATA_PATH_JSON = f"{DATA_DIR_PATH}/json/business_data/business_summarized_all_time.json"
